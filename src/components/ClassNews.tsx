...
const ClassNews: React.FC = () => {
  ...
  return (
    <div className="md:my-10 md:mx-10 py-4">
      <h1 className="md:text-4xl text-3xl font-bold m-6">Class News</h1>
            ...
            {editingArticleId === article.id ? (
              ...
              <>
                ...
                <div className="flex justify-between">
                  <h2 className="md:text-xl font-bold p-2">{article.title}</h2>
